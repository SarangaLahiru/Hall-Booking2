...
class Booking extends Model
{
     ...
     */
    protected $fillable = [
        'name', 'student_no', 'nic_no', 'phone', 'email', 'faculty', 'society', 'institution', 'post', 'category', 'event_type', 'event_description', 'booking_dates', 'facilities', 'documents','department','division','address'
    ];
