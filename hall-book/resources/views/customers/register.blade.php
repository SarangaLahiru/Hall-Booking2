            ...
            <div class="row g-0">
                <div class="col-12 col-md-6 text-bg-primary d-flex align-items-center justify-content-center">
                    <div class="text-center text-white p-4">
                        <h2 class="h1 mb-3">Join Us Today</h2>
                        <p class="lead mb-0">Be a part of our community and access exclusive content.</p>
                    </div>
                </div>
                <div class="col-12 col-md-6" id="formContainer" style="display: none;">
